...
public class CreateDatabase
{
	...
	{
		String[] tableNames = {
				"CREATE TABLE `bitki` (`_id` int(6) UNSIGNED NOT NULL, `bitki_adi` varchar(120) NOT NULL, `bitki_cinsi` varchar(120) NOT NULL, "
						+ "`bitki_turu` enum('YAPRAK','KOK','SEBZE','MEYVE','C?CEK') NOT NULL DEFAULT 'YAPRAK', `bitki_resim` varchar(120) DEFAULT NULL, "
						+ "`bitki_ulke` varchar(50) NOT NULL, `bitki_yore` varchar(120) NOT NULL, `bitki_ekme_zamani` date NOT NULL DEFAULT '0000-00-00', "
						+ "`bitki_yetisme_suresi` int(4) NOT NULL, `bitki_hasat_zamani` date NOT NULL DEFAULT '0000-00-00', `bitki_tohum_satici` varchar(120) DEFAULT NULL, "
						+ "`bitki_tohum_fiyat` varchar(6) DEFAULT NULL, `bitki_fide_satici` varchar(120) DEFAULT NULL, `bitki_fide_fiyat` varchar(6) DEFAULT NULL, "
						+ "`bitki_hasat_boy` varchar(5) DEFAULT NULL, `bitki_hasat_agirlik` varchar(6) DEFAULT NULL, `bitki_hasat_fiyat` varchar(6) DEFAULT NULL, "
						+ "`bitki_satis_tip` varchar(15) DEFAULT 'ADET', `bitki_dikim_tip` varchar(15) DEFAULT 'TOHUM', `bitki_isik_siddet` varchar(10) DEFAULT NULL, "
						+ "`bitki_isik_dalgaboy` varchar(6) DEFAULT NULL, `bitki_gunduz_isik_sure` varchar(2) DEFAULT NULL, `bitki_gece_isik_sure` varchar(2) DEFAULT NULL, "
						+ "`bitki_gunduz_ortam_isi` varchar(6) DEFAULT NULL, `bitki_gece_ortam_isi` varchar(6) DEFAULT NULL, `bitki_gunduz_nem` varchar(6) DEFAULT NULL, "
						+ "`bitki_gece_nem` varchar(6) DEFAULT NULL, `bitki_gunduz_o2` varchar(3) DEFAULT NULL, `bitki_gece_o2` varchar(3) DEFAULT NULL, "
						+ "`bitki_gunduz_c2o` varchar(3) DEFAULT NULL, `bitki_gece_c2o` varchar(3) DEFAULT NULL, `bitki_gunduz_cansuyu_isi` varchar(6) DEFAULT NULL, "
						+ "`bitki_gece_cansuyu_isi` varchar(6) DEFAULT NULL, `bitki_cansuyu_ph` varchar(5) DEFAULT NULL, `bitki_gunduz_gida_a` varchar(55) DEFAULT NULL, "
						+ "`bitki_gunduz_gida_b` varchar(55) DEFAULT NULL, `bitki_gunduz_gida_c` varchar(55) DEFAULT NULL, `bitki_gunduz_gida_d` varchar(55) DEFAULT NULL, "
						+ "`bitki_gunduz_gida_e` varchar(55) DEFAULT NULL, `bitki_gunduz_gida_f` varchar(55) DEFAULT NULL, `bitki_gece_gida_a` varchar(55) DEFAULT NULL, "
						+ "`bitki_gece_gida_b` varchar(55) DEFAULT NULL, `bitki_gece_gida_c` varchar(55) DEFAULT NULL, `bitki_gece_gida_d` varchar(55) DEFAULT NULL, "
						+ "`bitki_gece_gida_e` varchar(55) DEFAULT NULL, `bitki_gece_gida_f` varchar(55) DEFAULT NULL) "
				...
				"CREATE TABLE `hall` (`_id` int(10) UNSIGNED NOT NULL, `bolum_id` int(4) NOT NULL, `bitki_id` int(8) NOT NULL, `add_date` date DEFAULT '0000-00-00') ENGINE=InnoDB DEFAULT CHARSET=utf8;",
				...
				"CREATE TABLE `product_log` (`_id` int(12) UNSIGNED NOT NULL, `bolum_id` int(5) NOT NULL, `env_temp` int(3) NOT NULL COMMENT 'C°', `env_humid` int(3) NOT NULL COMMENT 'RH', "
						+ "`env_02` int(3) NOT NULL COMMENT '%', `env_co2` int(3) NOT NULL COMMENT '%', `env_light` int(3) NOT NULL COMMENT 'Lux', "
						+ "`env_pressure` int(3) NOT NULL COMMENT 'BAR', `env_water_temp` int(3) NOT NULL COMMENT 'C°', `env_water_ph` float NOT NULL COMMENT 'PH', "
						+ "`a_gida` varchar(10) NOT NULL COMMENT 'ppm', `b_gida` varchar(10) NOT NULL COMMENT 'ppm', `c_gida` varchar(10) NOT NULL COMMENT 'ppm', "
						+ "`d_gida` varchar(10) NOT NULL COMMENT 'ppm', `env_heat_valve` int(3) NOT NULL COMMENT '%', `env_cool_valve` int(3) NOT NULL COMMENT '%', "
						+ "`log_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00') " + "ENGINE=InnoDB DEFAULT CHARSET=utf8;",

				"CREATE TABLE `sys_log` (`_id` int(10) UNSIGNED NOT NULL, `hall_id` int(3) NOT NULL, `panel_id` int(6) NOT NULL, `env_temp` varchar(8) NOT NULL COMMENT 'ortam sicakligi', "
						+ "`env_humid` varchar(8) NOT NULL COMMENT 'ortam nem', `env_oxigen` varchar(8) NOT NULL COMMENT 'Ortam Oksijeni', `env_co2` varchar(8) NOT NULL COMMENT "
						+ "'Ortam Karbondioksit', `env_light` varchar(8) NOT NULL COMMENT 'Ortam Isik (Max 100)', `env_bar` varchar(5) NOT NULL, "
						+ "`env_water_ph` varchar(8) NOT NULL COMMENT 'Can suyu PH degeri', `env_water_temp` varchar(8) NOT NULL COMMENT 'Can suyu Sicakligi', "
						+ "`a_ingredient` varchar(8) NOT NULL COMMENT 'A G1da katk1 Miktar1 (Mg)', `b_ingredient` varchar(8) NOT NULL COMMENT 'B G1da katk1 Miktar1 (Mg)', "
						+ "`c_ingredient` varchar(8) NOT NULL COMMENT 'C G1da katk1 Miktar1 (Mg)', `x_ingredient` varchar(8) NOT NULL COMMENT 'D G1da katk1 Miktar1 (Mg)', "
						+ "`cool_pump_valve` varchar(5) NOT NULL, `heat_pump_valve` varchar(5) NOT NULL, `log_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00') "
						+ "ENGINE=InnoDB DEFAULT CHARSET=utf8;",

				"CREATE TABLE `user` (`_id` int(4) UNSIGNED NOT NULL, `auth_id` int(2) NOT NULL, `user_name` varchar(50) NOT NULL, `user_id` varchar(15) NOT NULL, `user_pass` varchar(60) NOT NULL, "
						+ "`user_mail` varchar(120) NOT NULL, `user_phone` varchar(22) NOT NULL, `user_register` datetime NOT NULL DEFAULT '0000-00-00 00:00:00', "
						+ "`user_last_login` int(1) DEFAULT NULL, `isActive` enum('1','0') NOT NULL DEFAULT '0') " + "ENGINE=InnoDB DEFAULT CHARSET=utf8;",

				"CREATE TABLE `user_auth` (`_id` int(2) UNSIGNED NOT NULL, `auth_label` varchar(1) NOT NULL, `auth_name` varchar(25) NOT NULL, `auth_read` enum('1','0') NOT NULL DEFAULT '0', "
						+ "`auth_write` enum('1','0') NOT NULL DEFAULT '0', `auth_edit` enum('1','0') NOT NULL DEFAULT '0', "
						+ "`auth_delete` enum('1','0') NOT NULL DEFAULT '0', `auth_new` enum('1','0') NOT NULL DEFAULT '0') "
						+ "ENGINE=InnoDB DEFAULT CHARSET=utf8;",

				"CREATE TABLE `user_log` (`_id` int(12) UNSIGNED NOT NULL, `user_id` int(4) NOT NULL, `login_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00', `logout_time` int(12) DEFAULT '0', "
						+ "`user_process` text NOT NULL) " + "ENGINE=InnoDB DEFAULT CHARSET=utf8;"};
		...
		String[] alterTables = {
				...
				"ALTER TABLE `user` MODIFY `_id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;",
				"ALTER TABLE `user_auth` MODIFY `_id` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;",
