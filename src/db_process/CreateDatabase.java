...
public class CreateDatabase
{
	...
	{
		String[] tableNames = {
				"CREATE TABLE `bitki` (`_id` int(6) UNSIGNED NOT NULL, `bitki_adi` varchar(120) NOT NULL, `bitki_cinsi` varchar(120) NOT NULL, `bitki_turu` enum('YAPRAK','KÖK','SEBZE','MEYVE','ÇİÇEK') NOT NULL DEFAULT 'YAPRAK', `bitki_resim` varchar(120) NOT NULL, `bitki_ulke` varchar(50) NOT NULL, `bitki_yore` varchar(120) NOT NULL, `bitki_ekme_zamani` varchar(12) NOT NULL, `bitki_yetisme_suresi` int(4) NOT NULL, `bitki_hasat_zamani` int(12) NOT NULL, `bitki_tohum_satici` varchar(120) DEFAULT NULL, `bitki_tohum_fiyat` float DEFAULT NULL, `bitki_fide_satici` varchar(120) DEFAULT NULL, `bitki_fide_fiyat` float DEFAULT NULL, `bitki_hasat_boy` int(5) NOT NULL, `bitki_hasat_agirlik` int(6) NOT NULL, `bitki_hasat_fiyat` float NOT NULL, `bitki_satis_tip` enum('ADET','DEMET','KASA','KG') NOT NULL DEFAULT 'ADET', `bitki_dikim_tip` enum('TOHUM','FİDE','SOGAN','') NOT NULL DEFAULT 'TOHUM', `bitki_isik_siddet` varchar(10) NOT NULL, `bitki_isik_dalgaboy` varchar(6) NOT NULL, `bitki_gunduz_isik_sure` int(2) NOT NULL, `bitki_gece_isik_sure` int(2) NOT NULL, `bitki_gunduz_ortam_isi` float NOT NULL, `bitki_gece_ortam_isi` float NOT NULL, `bitki_gunduz_nem` float NOT NULL, `bitki_gece_nem` float NOT NULL, `bitki_gunduz_o2` int(3) NOT NULL, `bitki_gece_o2` int(3) NOT NULL, `bitki_gunduz_c2o` int(3) NOT NULL, `bitki_gece_c2o` int(3) NOT NULL, `bitki_gunduz_cansuyu_isi` float NOT NULL, `bitki_gece_cansuyu_isi` float NOT NULL, `bitki_cansuyu_ph` varchar(5) NOT NULL, `bitki_gunduz_gida_a` int(5) NOT NULL, `bitki_gunduz_gida_b` int(5) NOT NULL, `bitki_gunduz_gida_c` int(5) NOT NULL, `bitki_gunduz_gida_d` int(5) NOT NULL, `bitki_gunduz_gida_e` int(5) NOT NULL, `bitki_gunduz_gida_f` int(5) NOT NULL, `bitki_gece_gida_a` int(5) NOT NULL, `bitki_gece_gida_b` int(5) NOT NULL, `bitki_gece_gida_c` int(5) NOT NULL, `bitki_gece_gida_d` int(5) NOT NULL, `bitki_gece_gida_e` int(5) NOT NULL, `bitki_gece_gida_f` int(5) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;",
				...
				"CREATE TABLE `pic_cards` (`_id` int(5) UNSIGNED NOT NULL, `pic_id` int(5) NOT NULL, `bitki_id` int(6) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;",
