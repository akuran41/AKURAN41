...
public class CreateDatabase
{
	...
	private void createTables() throws SQLException
	{
		String[] tableNames = {
				...
				"CREATE TABLE product_log (_id int(12) UNSIGNED NOT NULL, pic_id int(5) NOT NULL, env_temp int(3) NOT NULL COMMENT 'C°', env_humid int(3) NOT NULL COMMENT 'RH', env_02 int(3) NOT NULL COMMENT '%', env_co2 int(3) NOT NULL COMMENT '%', env_light int(3) NOT NULL COMMENT 'Lux', env_pressure int(3) NOT NULL COMMENT 'BAR', env_water_temp int(3) NOT NULL COMMENT 'C°', env_water_ph float NOT NULL COMMENT 'PH', a_gida varchar(10) NOT NULL COMMENT 'ppm', b_gida varchar(10) NOT NULL COMMENT 'ppm', c_gida varchar(10) NOT NULL COMMENT 'ppm', d_gida varchar(10) NOT NULL COMMENT 'ppm', env_heat_valve int(3) NOT NULL COMMENT '%', env_cool_valve int(3) NOT NULL COMMENT '%', log_time datetime NOT NULL DEFAULT '0000-00-00 00:00') ENGINE=InnoDB DEFAULT CHARSET=utf8;",
				"CREATE TABLE sys_log (`_id` int(10) UNSIGNED NOT NULL, hall_id int(3) NOT NULL, panel_id int(6) NOT NULL, env_temp varchar(8) NOT NULL COMMENT 'ortam sicakligi', env_humid varchar(8) NOT NULL COMMENT 'ortam nem', env_oxigen varchar(8) NOT NULL COMMENT 'Ortam Oksijeni', env_co2 varchar(8) NOT NULL COMMENT 'Ortam Karbondioksit', env_light varchar(8) NOT NULL COMMENT 'Ortam Isik (Max 100)', env_bar varchar(5) NOT NULL, env_water_ph varchar(8) NOT NULL COMMENT 'Can suyu PH degeri', env_water_temp varchar(8) NOT NULL COMMENT 'Can suyu Sicakligi', a_ingredient varchar(8) NOT NULL COMMENT 'A G1da katk1 Miktar1 (Mg)', b_ingredient varchar(8) NOT NULL COMMENT 'B G1da katk1 Miktar1 (Mg)', c_ingredient varchar(8) NOT NULL COMMENT 'C G1da katk1 Miktar1 (Mg)', x_ingredient varchar(8) NOT NULL COMMENT 'D G1da katk1 Miktar1 (Mg)', cool_pump_valve varchar(5) NOT NULL, heat_pump_valve varchar(5) NOT NULL, log_time datetime NOT NULL DEFAULT '0000-00-00 00:00' ) ENGINE=InnoDB DEFAULT CHARSET=utf8;",
